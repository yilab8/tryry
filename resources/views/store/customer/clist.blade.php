            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label>{{ __('公司名稱') }}</label>
                            <input type="text" class="form-control" v-model="searchData.name" placeholder="{{ __('公司名稱') }}" @keyup="get()">
                        </div>
                        <div class="form-group col-md-3">
                            <label>{{ __('公司帳號') }}</label>
                            <input type="text" class="form-control" v-model="searchData.account" placeholder="{{ __('公司帳號') }}" @keyup="get()">
                        </div>
...
<script type="text/javascript">
    var vc = new Vue({
        ...
        methods: {
            ...
            goEdit(id){
                location.href = '{{ route('store.customer.cedit') }}/'+id
            },
        },
        created : function(){
            this.get();
