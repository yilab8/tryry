                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col" @click="get('sort','store_product_category.name')">{{ __('default.類別') }}</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    var vc = new Vue({
        ...
        methods: {
            ...
            get(type = false, sort = false) {
                ...
                vc = this;
                let url = "{{ config('services.API_URL').'/store_product_category' }}"
                $.ajax({
                    method: "GET",
                    url: url,
                    data: vc.searchData,
            ...
            checkSave(){
                ...
                if(vc.editData.id >= 1){
                    method = "PUT";
                    url = "{{ config('services.API_URL').'/store_product_category' }}/"+vc.editData.id;
                }
            ...
            checkSortSave(){
                let method = "POST";
                let url = "{{ config('services.API_URL').'/store_product_category/update_sort' }}";
