                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col" @click="get('sort','store_service_category.name')">{{ __('default.類別') }}</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    var vc = new Vue({
        ...
        methods: {
            ...
            checkSave(){
                ...
                if(vc.editData.id >= 1){
                    method = "PUT";
                    url = "{{ config('services.API_URL').'/store_service_category' }}/"+vc.editData.id;
                }
            ...
            checkSortSave(){
                let method = "POST";
                let url = "{{ config('services.API_URL').'/store_service_category/update_sort' }}";
