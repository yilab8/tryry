<nav v-cloak class="mt-4 mb-3" v-if="pageData">
    <ul class="pagination justify-content-center mb-0">
        <!-- <li class="page-item">
            <a class="page-link first" href="#" @click.prevent="get('up')">
        ...
        <li class="page-item">
            <select v-model="pageData.current_page" @change="get()" class="form-control">
                <option v-if="!pageData.last_page || pageData.last_page < 1" value="1" selected>1</option>
