<script type="text/javascript">
    ...
    $(function(){
        setActiveMenu('{{ !empty($activeMenu->parent)?$activeMenu->parent->id:0 }}', '{{ !empty($activeMenu)?$activeMenu->id:0 }}');
    ...
    function setActiveMenu(menu1_id = 0, menu2_id = 0){
        $('[id^="menu1-li"]').removeClass('active');
        $('[id^="menu2-li"]').removeClass('active');
