<style type="text/css">
    ...
    /*.btn-primary{
        background-color: {{ $baseBtnColor ?? '#F89D26' }};
        border-color: {{ $baseBtnColor ?? '#F89D26' }};
    }
    .btn-primary:hover, .btn-primary:focus, .btn-primary:active, .btn-primary.active{
        background-color: {{ $baseBtnColor ?? '#F89D26' }}DD !important;
        border-color: {{ $baseBtnColor ?? '#F89D26' }}DD !important;
    }
    .btn-primary:disabled{
        background-color: {{ $baseBtnColor ?? '#F89D26' }}77;
        border-color: {{ $baseBtnColor ?? '#F89D26' }}77;
    }*/
